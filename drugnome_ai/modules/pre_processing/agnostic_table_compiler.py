...
class AgnosticTableCompiler:

    def __init__(self, cfg):
        self.cfg = cfg
        self.full_features_df = None
        print("Agnostic Table Compiler launched")
    ...
    def combine_all_feature_tables(self):
        ...
        self.full_features_df = reduce(lambda df1, df2: pd.merge(df1, df2, how='outer', on='Gene_Name'), datasets)
...
if __name__ == '__main__':
    ...
    cfg = Config(out_dir)
    cfg.tier_tag = ['Tier 1']
    feat_compiler = AgnosticTableCompiler(cfg)
    feat_compiler.run()
