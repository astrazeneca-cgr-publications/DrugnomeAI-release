...
from drugnome_ai.modules.supervised_learn.core.ml_plot_functions import plot_confusion_matrix
...
class GenericClassifier:
    ...
    def plot_confusion_matrix(self, verbose=True):
        ...
        plot_confusion_matrix(confusion, classes=['unrelated', 'known genes'],
