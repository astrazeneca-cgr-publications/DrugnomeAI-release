...
class MantisMlProfiler:
	...
	def __init__(self, output_dir, config_file, verbose=False):
	...
	def run_mantis_ml_profiler(self):
		...
		cfg = Config(self.output_dir, self.config_file)
...
def main():
	...
	profiler = MantisMlProfiler(output_dir, config_file, verbose=verbose)
